...
public class StatementState implements AbstractStateWithLocation, AbstractQueryableState, Partitionable, Serializable {
  ...
  static class BackwardsLocationState extends StatementState {
  ...
  StatementState(CFANode pLocationNode, boolean pFollowFunctionCalls) {
