 ...
 */
public abstract class RangeAnalysisDelegatingRefiner implements Refiner {

  @SuppressWarnings("resource")
  public static Refiner create(ConfigurableProgramAnalysis cpa)
      throws InvalidConfigurationException {
    RangeAnalysisCPA valueCpa =
        CPAs.retrieveCPAOrFail(cpa, RangeAnalysisCPA.class, RangeAnalysisDelegatingRefiner.class);
    PredicateCPA predicateCpa =
        CPAs.retrieveCPAOrFail(cpa, PredicateCPA.class, RangeAnalysisDelegatingRefiner.class);
    ...
    return AbstractARGBasedRefiner.forARGBasedRefiner(
        new DelegatingARGBasedRefinerWithRefinementSelection(
            ...
            RangeAnalysisRefiner.create0(cpa),
            new RangeAnalysisPrefixProvider(logger, cfa, config, valueCpa.getShutdownNotifier()),
