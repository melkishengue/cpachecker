...
public class RangeAnalysisFeasibilityChecker
    extends GenericFeasibilityChecker<RangeAnalysisState> {

  private final StrongestPostOperator<RangeAnalysisState> strongestPostOp;
   ...
   */
  public RangeAnalysisFeasibilityChecker(
      final StrongestPostOperator<RangeAnalysisState> pStrongestPostOp,
    ...
    super(
        pStrongestPostOp,
        new RangeAnalysisState(pCfa.getMachineModel()),
    ...
    precision = VariableTrackingPrecision.createStaticPrecision(config, pCfa.getVarClassification(), RangeAnalysisCPA.class);
    machineModel = pCfa.getMachineModel();
  }

  public List<Pair<RangeAnalysisState, List<CFAEdge>>> evaluate(final ARGPath path)
      throws CPAException, InterruptedException {

    try {
      List<Pair<RangeAnalysisState, List<CFAEdge>>> reevaluatedPath = new ArrayList<>();
      RangeAnalysisState next = new RangeAnalysisState(machineModel);
