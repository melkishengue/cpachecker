...
public class RangeAnalysisPrefixProvider extends GenericPrefixProvider<RangeAnalysisState> {
   ...
   */
  public RangeAnalysisPrefixProvider(
      LogManager pLogger, CFA pCfa, Configuration config, ShutdownNotifier pShutdownNotifier)
      throws InvalidConfigurationException {

    super(
        new RangeAnalysisStrongestPostOperator(pLogger, config, pCfa),
