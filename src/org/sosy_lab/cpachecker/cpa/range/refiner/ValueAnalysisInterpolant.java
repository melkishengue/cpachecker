 ...
 */
public final class RangeAnalysisInterpolant
    implements Interpolant<RangeAnalysisState, RangeAnalysisInterpolant> {
   ...
   */
  public static final RangeAnalysisInterpolant TRUE  = new RangeAnalysisInterpolant();

  /** the interpolant representing "false" */
  public static final RangeAnalysisInterpolant FALSE = new RangeAnalysisInterpolant(null);

  /**
   * Constructor for a new, empty interpolant, i.e. the interpolant representing "true"
   */
  private RangeAnalysisInterpolant() {
   ...
   */
  public RangeAnalysisInterpolant(PersistentMap<MemoryLocation, ValueAndType> pAssignment) {
   ...
   */
  public static RangeAnalysisInterpolant createInitial() {
    return new RangeAnalysisInterpolant();
  }
   ...
   */
  @Override
  public RangeAnalysisInterpolant join(final RangeAnalysisInterpolant other) {
    ...
    return new RangeAnalysisInterpolant(newAssignment);
  }
  ...
  public boolean equals(Object obj) {
    ...
    RangeAnalysisInterpolant other = (RangeAnalysisInterpolant) obj;
   ...
   */
  @Override
  public RangeAnalysisState reconstructState() {
    if (assignment == null) {
      throw new IllegalStateException("Can't reconstruct state from FALSE-interpolant");
    } else {
      return new RangeAnalysisState(Optional.empty(), assignment);
    }
  }
  ...
  public boolean strengthen(RangeAnalysisState valueState, ARGState argState) {
    if (isTrivial()) {
      return false;
    }
  ...
  public RangeAnalysisInterpolant weaken(Set<String> toRetain) {
    if (isTrivial()) {
      return this;
    }
    ...
    return new RangeAnalysisInterpolant(weakenedAssignments);
  }
