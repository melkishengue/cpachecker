...
public class RangeAnalysisTest {
  ...
  public void ignoreVariablesTest1() throws Exception {
    ...
    Map<String, String> prop =
        ImmutableMap.of(
            "CompositeCPA.cpas",
                "cpa.location.LocationCPA, cpa.callstack.CallstackCPA, cpa.range.RangeAnalysisCPA",
            "specification", "config/specification/default.spc",
            "RangeAnalysisCPA.precision.variableBlacklist", "__SELECTED_FEATURE_(\\w)*",
  ...
  public void ignoreVariablesTest2() throws Exception {
    ...
    Map<String, String> prop = ImmutableMap.of(
        "CompositeCPA.cpas", "cpa.location.LocationCPA, cpa.callstack.CallstackCPA, cpa.range.RangeAnalysisCPA",
        "specification",     "config/specification/default.spc",
        "RangeAnalysisCPA.precision.variableBlacklist", "somethingElse"
      );
