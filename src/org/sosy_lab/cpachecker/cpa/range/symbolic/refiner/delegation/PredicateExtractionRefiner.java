...
/**
 * {@link Refiner} for {@link RangeAnalysisCPA} using symbolic values and {@link ConstraintsCPA}
...
public abstract class PredicateExtractionRefiner implements Refiner {
  ...
  public static Refiner create(final ConfigurableProgramAnalysis pCpa)
    ...
    final RangeAnalysisCPA RangeAnalysisCpa =
        CPAs.retrieveCPAOrFail(pCpa, RangeAnalysisCPA.class, PredicateExtractionRefiner.class);
