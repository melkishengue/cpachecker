 ...
 * A composition of {@link ConstraintsTransferRelation} and {@link RangeAnalysisTransferRelation}
 * is used for checking feasibility.
 * In contrast to this approach, {@link RangeAnalysisFeasibilityChecker} only uses a
 * RangeAnalysisTransferRelation and as such cannot fully handle symbolic values.
 */
public class SymbolicRangeAnalysisFeasibilityChecker
    extends GenericFeasibilityChecker<ForgettingCompositeState>
    implements SymbolicFeasibilityChecker {

  public SymbolicRangeAnalysisFeasibilityChecker(
  ...
  private static ForgettingCompositeState getInitialCompositeState(MachineModel pMachineModel) {
    final RangeAnalysisState valueState = new RangeAnalysisState(pMachineModel);
