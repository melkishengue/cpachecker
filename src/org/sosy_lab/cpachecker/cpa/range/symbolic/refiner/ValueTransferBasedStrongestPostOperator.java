...
public class ValueTransferBasedStrongestPostOperator
  ...
  private final RangeAnalysisTransferRelation valueTransfer;
  // used for abstraction
  private final RangeAnalysisStrongestPostOperator valueStrongestPost;
  ...
  public ValueTransferBasedStrongestPostOperator(
    ...
    valueStrongestPost = new RangeAnalysisStrongestPostOperator(pLogger, pConfig, pCfa);
  ...
  public Optional<ForgettingCompositeState> getStrongestPost(
    ...
    RangeAnalysisState oldValues = pOrigin.getValueState();
    ...
    if (isContradiction(successors)) {
      ...
      final RangeAnalysisState valuesSuccessor = Iterables.getOnlyElement(successors);
      ...
      if (!constraintsStrengthenResult.isPresent()) {
        ...
        Optional<RangeAnalysisState> valueStrengthenResult =
  ...
  public ForgettingCompositeState handleFunctionReturn(
    ...
    RangeAnalysisState currentValueState = pNext.getValueState();
    RangeAnalysisState callStateValueState = callState.getValueState();
  ...
  public ForgettingCompositeState performAbstraction(
    ...
    RangeAnalysisState oldValueState = pNext.getValueState();

    assert pPrecision instanceof VariableTrackingPrecision;
    RangeAnalysisState newValueState =
  ...
  private Optional<RangeAnalysisState> strengthenValueState(
    ...
    if (isContradiction(strengthenResult)) {
      ...
      return Optional.of((RangeAnalysisState) onlyState);
    }
  }
  ...
  private ForgettingCompositeState getNewCompositeState(final RangeAnalysisState pNextValueState,
      final ConstraintsState pConstraints) {
