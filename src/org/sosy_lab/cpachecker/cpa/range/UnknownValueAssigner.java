...
public final class UnknownValueAssigner implements MemoryLocationValueHandler {
  ...
  /**
   * Remove the given {@link MemoryLocation} from the given {@link RangeAnalysisState}.
   *
   * @param pMemLocation the memory location to remove
   * @param pType the type of the memory location that should be removed
   * @param pState the {@link org.sosy_lab.cpachecker.cpa.range.RangeAnalysisState} to use.
  ...
  public void handle(
      ...
      @Nullable ExpressionRangeVisitor pValueVisitor) {
