...
class RangeAnalysisReducer extends GenericReducer<RangeAnalysisState, VariableTrackingPrecision> {

  @Override
  protected RangeAnalysisState getVariableReducedState0(
      RangeAnalysisState pExpandedState, Block pContext, CFANode pCallNode) {
    RangeAnalysisState clonedElement = RangeAnalysisState.copyOf(pExpandedState);
  ...
  @Override
  protected RangeAnalysisState getVariableExpandedState0(
      RangeAnalysisState pRootState, Block pReducedContext, RangeAnalysisState pReducedState) {
    ...
    RangeAnalysisState diffElement = RangeAnalysisState.copyOf(pReducedState);
  ...
  protected Object getHashCodeForState0(
      RangeAnalysisState pElementKey, VariableTrackingPrecision pPrecisionKey) {
    return Pair.of(pElementKey, pPrecisionKey);
  }

  @Override
  protected RangeAnalysisState rebuildStateAfterFunctionCall0(
      RangeAnalysisState pRootState,
      RangeAnalysisState entryState,
      RangeAnalysisState pExpandedState,
