...
public final class RangeAnalysisState
    implements AbstractQueryableState, FormulaReportingState,
        ForgetfulState<RangeAnalysisInformation>, Serializable, Graphable,
        LatticeAbstractState<RangeAnalysisState>, PseudoPartitionable {
  ...
  public RangeAnalysisState(MachineModel pMachineModel) {
    this(
        checkNotNull(pMachineModel),
        PathCopyingPersistentTreeMap.of());
  }

  public RangeAnalysisState(
  ...
  private RangeAnalysisState(RangeAnalysisState state) {
  ...
  public static RangeAnalysisState copyOf(RangeAnalysisState state) {
    return new RangeAnalysisState(state);
  }
  ...
  void assignConstant(String variableName, Value value) {
    addToConstantsMap(MemoryLocation.rangeOf(variableName), value, null);
  }
      ...
      if (pValue.isNumericValue()) {
        CIntegerLiteralExpression valueAsExpression =
            new CIntegerLiteralExpression(
                FileLocation.DUMMY,
                memLocType,
                BigInteger.rangeOf(pValue.asNumericValue().longValue()));
        try {
   ...
   */
  @Override
  public RangeAnalysisInformation forget(MemoryLocation pMemoryLocation) {

    if (!constantsMap.containsKey(pMemoryLocation)) {
      return RangeAnalysisInformation.EMPTY;
    }
    ...
    return new RangeAnalysisInformation(valueAssignment);
  }

  @Override
  public void remember(final MemoryLocation pLocation, final RangeAnalysisInformation pValueAndType) {
   ...
   */
  @Override
  public RangeAnalysisState join(RangeAnalysisState reachedState) {
    ...
    if (newConstantsMap.size() == reachedState.constantsMap.size()) {
      ...
      return new RangeAnalysisState(machineModel, newConstantsMap);
    }
  }
   ...
   */
  @Override
  public boolean isLessOrEqual(RangeAnalysisState other) {
  ...
  public boolean equals(Object other) {
    ...
    RangeAnalysisState otherElement = (RangeAnalysisState) other;
  ...
  public Object evaluateProperty(String pProperty) throws InvalidQueryException {
    ...
    if (pProperty.startsWith("contains(")) {
      ...
      return this.constantsMap.containsKey(MemoryLocation.rangeOf(varName));
    } else {
      List<String> parts = Splitter.on("==").trimResults().splitToList(pProperty);
      if (parts.size() != 2) {
        ValueAndType value = this.constantsMap.get(MemoryLocation.rangeOf(pProperty));
  ...
  public boolean checkProperty(String pProperty) throws InvalidQueryException {
    ...
    if (parts.size() != 2) {
      ...
      ValueAndType val = this.constantsMap.get(MemoryLocation.rangeOf(parts.get(0)));
      if (val == null) {
        return false;
      }
  ...
  public void modifyProperty(String pModification) throws InvalidQueryException {
    ...
    for (String statement : Splitter.on(';').trimResults().split(pModification)) {
      if (startsWithIgnoreCase(statement, "deletevalues(")) {
        ...
        MemoryLocation varName = MemoryLocation.rangeOf(
   ...
   */
  @Deprecated
  public Set<MemoryLocation> getDifference(RangeAnalysisState other) {
   ...
   */
  public RangeAnalysisInterpolant createInterpolant() {
    return new RangeAnalysisInterpolant(constantsMap);
  }

  public RangeAnalysisInformation getInformation() {
    return new RangeAnalysisInformation(constantsMap);
  }
  ...
  public RangeAnalysisState rebuildStateAfterFunctionCall(final RangeAnalysisState callState, final FunctionExitNode functionExit) {
    ...
    final RangeAnalysisState rebuildState = RangeAnalysisState.copyOf(callState);
  ...
  public static class ValueAndType implements Serializable {
    ...
    public boolean equals(Object o) {
      ...
      return Objects.equals(value, other.range) && Objects.equals(type, other.type);
    }
