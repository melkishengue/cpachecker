 ...
 */
package org.sosy_lab.cpachecker.cpa.range.type;
...
/**
 * Stores a numeric value that can be tracked by the RangeAnalysisCPA.
 */
public class NumericValue implements Value, Serializable {
  ...
  public BigDecimal bigDecimalValue() {
    if (number instanceof Double || number instanceof Float) {
      ...
      return BigDecimal.rangeOf(number.doubleValue());
  ...
  public NumericValue negate() {
    ...
    if (numberToNegate instanceof Float) {
      if (numberToNegate.equals(Float.POSITIVE_INFINITY)) {
        ...
        return new NumericValue(NegativeNaN.range);
      }
    ...
    } else if (NegativeNaN.range.equals(numberToNegate)) {
