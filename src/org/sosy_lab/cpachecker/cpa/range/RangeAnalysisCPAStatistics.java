...
public class RangeAnalysisCPAStatistics implements Statistics {
  ...
  private final RangeAnalysisCPA cpa;

  public RangeAnalysisCPAStatistics(RangeAnalysisCPA cpa, Configuration config) throws InvalidConfigurationException {
    this.cpa = cpa;

    config.inject(this, RangeAnalysisCPAStatistics.class);
  }

  @Override
  public String getName() {
    return "RangeAnalysisCPA";
  }
  ...
  public void printStatistics(PrintStream out, Result result, UnmodifiableReachedSet reached) {
    ...
    for (AbstractState currentAbstractState : reached) {
      RangeAnalysisState currentState = AbstractStates.extractStateByType(currentAbstractState, RangeAnalysisState.class);
