...
public class RangeAnalysisPrecisionAdjustment implements PrecisionAdjustment {

  @Options(prefix = "cpa.range.abstraction")
  ...
  public static class PrecAdjustmentStatistics implements Statistics {
    ...
    public String getName() {
      return "RangeAnalysisPrecisionAdjustment";
    }
  }

  private final RangeAnalysisCPAStatistics stats;
  ...
  public RangeAnalysisPrecisionAdjustment(
  ...
  public Optional<PrecisionAdjustmentResult> prec(AbstractState pState, Precision pPrecision, UnmodifiableReachedSet pStates,
    ...
    return prec((RangeAnalysisState)pState,
  ...
  private Optional<PrecisionAdjustmentResult> prec(RangeAnalysisState pState,
      VariableTrackingPrecision pPrecision,
      LocationState location,
      UniqueAssignmentsInPathConditionState assignments) {
    RangeAnalysisState resultState = RangeAnalysisState.copyOf(pState);
  ...
  private void enforceLiveness(RangeAnalysisState pState, LocationState location, RangeAnalysisState resultState) {
   ...
   */
  private void enforcePrecision(RangeAnalysisState state, LocationState location, VariableTrackingPrecision precision) {
   ...
   */
  private void enforcePathThreshold(RangeAnalysisState state,
      UniqueAssignmentsInPathConditionState assignments) {
