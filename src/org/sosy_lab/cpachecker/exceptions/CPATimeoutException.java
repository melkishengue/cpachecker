 ...
 * abandoned.
 */
public class CPATimeoutException extends CPAException {

  private static final long serialVersionUID = 513019120577549278L;

  private final List<ARGPath> paths;

  public CPATimeoutException(String msg, List<ARGPath> pInfeasibleErrorPaths) {
    super(msg);
    paths = pInfeasibleErrorPaths;
  }

  public CPATimeoutException(String msg, List<ARGPath> p, Throwable t) {
